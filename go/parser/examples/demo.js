...
function demo() {
    return __awaiter(this, void 0, void 0, function () {
        var parser, parseResult, editResult;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    parser = new wrapper_1.GoParser();
                    // Parse the file to get symbols
                    console.log('Parsing file...');
                    return [4 /*yield*/, parser.parseFile('examples/test.go')];
                case 1:
                    parseResult = _a.sent();
                    console.log('Symbols found:', parseResult.symbols);
                    // Edit the ProcessData function
                    console.log('\nEditing ProcessData function...');
                    return [4 /*yield*/, parser.editSymbol('examples/test.go', {
